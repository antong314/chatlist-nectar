...
export const machucaTheme = {
  colors: {
    ...
    offWhite: '#FAF9F6',
    neutralGray: '#9E9E9E',
    directoryGreen: '#24573A',
    directoryLeaf: '#63844C',
    directoryRiver: '#2E6F7E',
    directoryPapaya: '#DF7D35',
    directoryCream: '#F5ECD8',
    directoryPaper: '#FFFDF8',
    directoryInk: '#243027',
    directoryWhatsApp: '#167C3A',
...
export const machucaCSSVariables = {
  ...
  '--directory-green': machucaTheme.colors.directoryGreen,
  '--directory-leaf': machucaTheme.colors.directoryLeaf,
  '--directory-river': machucaTheme.colors.directoryRiver,
  '--directory-papaya': machucaTheme.colors.directoryPapaya,
  '--directory-cream': machucaTheme.colors.directoryCream,
  '--directory-paper': machucaTheme.colors.directoryPaper,
  '--directory-ink': machucaTheme.colors.directoryInk,
  '--directory-whatsapp': machucaTheme.colors.directoryWhatsApp,
